...
static int[] arrTambahFinal = new int[99];
static int[] arrKurangFinal = new int[99];
static int[] arrTotalKurang= new int[99];
...
System.out.println("Jumlah " + cari + " sebanyak " + totFinal[dicari] + " ,Rusak sebanyak " + arrRusak[dicari] + " ,dan Berada di Gudang " + arrGudang[dicari]);
return i;
